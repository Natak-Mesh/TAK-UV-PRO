...
public final class ContactRadialMenuUtil {
    ...
    public static void applyPingCapableRadialMenu(MapItem item, IndividualContact contact) {
        ...
        if (UVProContactHandler.resolvePingTargetCallsign(contact).isEmpty()) {
    ...
    /** Removes legacy base64 full-menu overrides that break the stock radial menu. */
    ...
    public static void handleRadialPingContact(Context context, String contactUid) {
        ...
        String atakTarget = UVProContactHandler.resolvePingTargetCallsign(ic);
