...
/**
 * Clears plugin MeshCore Bluetooth history and attempts to unpair mesh devices
 * from the phone's Bluetooth stack.
 */
public final class MeshBluetoothForgetAll {

    private static final String TAG = "UVPro.MeshForgetAll";
    ...
    @NonNull
    public static Result forgetAll(@NonNull Context context, BluetoothAdapter adapter) {
    ...
    public static Result forgetAll(@NonNull Context context,
                ...
                if (bonded != null) {
                    for (BluetoothDevice device : bonded) {
                        ...
                        if (MeshBleDeviceMatcher.isMeshDevice(context, device)) {
                            ...
                            if (addr != null) addresses.add(normalize(addr));
                        }
                    }
                }
            } catch (Exception e) {
        ...
        int attempted = 0, removed = 0, failed = 0;
        if (adapter != null) {
