...
public class QrScanActivity extends Activity implements SurfaceHolder.Callback {
    ...
    private static final String TAG = "UVPro.QrScan";
    ...
    private void openCamera() {
        ...
        // else surfaceCreated will call startCameraPreview
    }
    ...
    private void startCameraPreview() {
        ...
        try {
            ...
            // Request autofocus for QR scanning
    ...
    private void onPreviewFrame(byte[] data, Camera cam) {
        ...
        new Thread(() -> {
            try {
                ...
                // Nothing decoded this frame — keep scanning
            } finally {
                decoding = false;
            }
        }).start();
