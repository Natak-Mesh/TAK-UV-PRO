...
/**
 * Cross-process QR scan result handoff. QrScanActivity runs in the plugin process;
 * UVProDropDownReceiver runs in the ATAK process — file/SharedPrefs IPC fails across UIDs.
 */
public class QrResultProvider extends ContentProvider {

    public static final String AUTHORITY = "com.uvpro.plugin.qrresult";
    ...
    public static void storePending(Context context, String content) {
        ...
        try {
            ...
            android.util.Log.w("UVPro.QrResult", "storePending failed", e);
        }
    }

    /** @return scanned payload, or null if none / stale */
    public static String consumePending(Context context, long maxAgeMs) {
        try (Cursor cursor = context.getContentResolver().query(
            ...
            android.util.Log.w("UVPro.QrResult", "consumePending failed", e);
            return null;
        }
    }
}
