 ...
 *
 * <p>Regenerate hash: {@code echo -n 'YOUR_PASSWORD' | sha256sum}
 */
public final class AdminAccessGate {

    public static final String PREF_UNLOCKED = "uvpro_admin_access_unlocked";

    /**
     * SHA-256 hex digest of the administrative password (lowercase hex).
     * Replace via {@link #sha256Hex(String)} — never commit the plaintext password.
     */
