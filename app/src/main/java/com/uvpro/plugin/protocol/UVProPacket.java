...
public class UVProPacket {
     ...
     */
    public static UVProPacket createCotAck(String cotUid) {
        ...
        return new UVProPacket(TYPE_COT_ACK, payload);
    }
    ...
    public static UVProPacket createPingPacket(String callsign) {
        return new UVProPacket(TYPE_PING, encodePingPayload(callsign, null));
    }

    /** Create a directed ping — only the target callsign should send a ping reply. */
    public static UVProPacket createDirectedPingPacket(String senderCallsign,
                                                       String targetCallsign) {
        return new UVProPacket(TYPE_PING,
